...
INSTANTIATE_TEST_SUITE_P(Parametrized, AssemblerTests,
    testing::Values(
        AssemblerTestParam("programs/4bit_addition.asm", {
            0xFE, 0xFF, 0x20, 0xA2, 0xA0, 0x81, 0xB1, 0x40,
            0x05
        }),
        AssemblerTestParam("programs/4bit_and_subroutine.asm", {
            0xFE, 0xFF, 0x28, 0x00, 0x29, 0xEA, 0xB0, 0x68,
            0x29, 0xEA, 0xB1, 0x50, 0x18, 0xB2, 0xE1, 0x40,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0xF0, 0xB2, 0xD4, 0xB0, 0xF6, 0xB0,
            0x1A, 0x2A, 0xB1, 0xF6, 0xB1, 0xB2, 0xF6, 0xB2,
            0xF8, 0x1C, 0x1B, 0xC0, 0xB1, 0xF6, 0xB1, 0xF1,
            0x40, 0x23
        }),
        AssemblerTestParam("programs/ram_test.asm", {
            0xFE, 0xFF, 0x20, 0x00, 0x22, 0x00, 0xDC, 0xB2, 0x21, 0xE0,
        ...
        AssemblerTestParam("programs/mcs4_evaluation.asm", {
            0xFE, 0xFF, 0xE2, 0xCF, 0x2A, 0x41, 0x50, 0xDE, 0x50, 0xE5,
